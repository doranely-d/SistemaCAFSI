...
<h2 class="text-center">Nueva Cita</h2><br>

<script type="text/javascript">
    function buscarPorID() {
        var id = document.getElementById("id").value;
        if (id.toString() !== "") {
            location.href = "registrar_nueva_cita.php?id=" + id;
        } else {
...
<form action="nueva_cita.php" method="post">
    <div class="panel panel-default">
        <div class="panel-heading">Búsqueda de paciente</div>
...
if (isset($_POST["submit"])) {
    ...
    if (empty($nombre) && empty($apellido)) {
        Errors::mostrar_error("nueva_cita.php", 6);
    ...
    if ($resultado) {
        if ($resultado->num_rows > 0) {
                    ...
                    <table border="1" class="tabla2">
                        ...
                        while ($registro = $resultado->fetch_array()) {
                            ...
                            <tr style="background-color: <?php echo($hipertension == 1? "orange" : "white") ?>">
                                ...
                                <td><input type="button" value="Elegir..." class="btn btn-primary" onclick="location.href = 'registrar_nueva_cita.php?id=<?php echo($bd_id_paciente); ?>'"></td>
                            </tr>
                            <?php
                        }
                        $bd->close();
            ...
            Errors::mostrar_error("nueva_cita.php", 4);
        }
    } else {
        Errors::mostrar_error("nueva_cita.php", 100);
    }
}
?>
